...
latex_documents = [
    (master_doc, 'Quest.tex', u'OURPACKAGE Documentation',
     u'YOUR NAME', 'manual'),
]
...
man_pages = [
    (master_doc, 'Quest', u'Quest Documentation',
     [author], 1)
]
